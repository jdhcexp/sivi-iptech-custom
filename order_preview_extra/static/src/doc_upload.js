...
export class DocUpload extends Component {
    ...
    setup() {
        ...
        this.state = useState({ sendEnabled:true,  type: "nat", files:[], ccname:'', ccnameback:'', servname:'', rutname:'', cycname:'', ccrname:'', ccrnameback:'', hidecc:false, hideccback: false, hideserv:false, hiderut:false, hidecyc:false, hideccr:false, hideccrback: false });
    ...
    async uploadDoc() {
        ...
        var validated = true;
        var msg = "Debe cargar todos los archivos:\n"
        ...
        else
        {
            ...
            for (const x of this.state.files) {
                ...
                await fetch('https://iptechservice.sivi.app/upload', {
                    ...
                    .then(data => {
                        ...
                        if(x.type=='cedula representante frente'){
            ...
            if(sendescount == this.state.files.length){
                this.state.sendEnabled = false;
            }
        }
