odoo.define('crnd_wsd_field_service.tour_request_new_with_fields_service', function (require) {
    'use strict';

    var tour = require('web_tour.tour');

    tour.register('crnd_wsd_field_service_tour' +
    '_request_new_with_fields_service', {
        test: true,
        url: '/requests/new',
    }, [
        {
        ...
        },
        {
            ...
            trigger: "#request-data-fields-top > div:has(label:contains(" +
                "'CPU')):contains() > input[name^='request_field_cpu']",
            run: "text 2 Cores",
        },
        {
            ...
            run: function () {
                $("#request_text").trumbowyg('html', "<h1>Test " +
                    "create-vm request</h1>");
            },
        },
        {
