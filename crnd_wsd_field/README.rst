...
This module provides integration between the Website Service Desk and Generic Request Fileds modules. It adds custom fields (string) to fill in while submitting the request.
